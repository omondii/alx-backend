...
class Server:
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> Dict[str, Union[int, List[Dict[str, Any]]]]:
         """ get_hyper method that takes the same arguments (and defaults) as get_page and returns a dictionary containing 
